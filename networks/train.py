...
if __name__ == "__main__":
    ...
    loss_vel, aae_vel = train_velometry_component(input_file_paths, OpticalFlowNet(), epochs=5)
    # loss_norm, aae_norm = train_velometry_component(input_file_paths, DepthMapNet(), epochs=1)
